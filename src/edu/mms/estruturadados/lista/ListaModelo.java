...
public class ListaModelo <T> {
	/*
	 *Declaração das variáveis. 
	 */
	public T[] elementos; //vetor de Strings
	public int tamanho; //variavel para amarzenar o tamanho real do vetor.
	 ...
	 */
	public ListaModelo(int capacidade){
	 ...
	 */
	public ListaModelo(int capacidade, Class<T> tipoClasse){
